...
investmentsRouter.post("/:id/documents", async (c) => {
...
investmentsRouter.get("/:id/documents", async (c) => {
  const id = c.req.param("id");
  try {
...
investmentsRouter.get("/documents/:docId", async (c) => {
...
investmentsRouter.delete("/documents/:docId", async (c) => {
  const docId = c.req.param("docId");
  try {
